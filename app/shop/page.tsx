...
export default function ShopPage() {
  ...
  const filteredProducts = useMemo(() => {
    return products.filter(product => {
      ...
      if (filters.organic) {
        const isOrganic = product.isOrganic || product.tags?.includes('organic');
  ...
  const clearFilters = () => {
    setFilters({ categories: [], priceRange: [0, 1000], rating: null, inStock: false, organic: false });
  };
  ...
  return (
    <div className="min-h-screen bg-white mt-40">
      <div className="px-4 sm:px-6 lg:px-15 py-8 sm:py-12 lg:py-16 mt-8 sm:mt-12 lg:mt-16">
        ...
        {/* ── Header — matches ProductCatalog .info style ── */}
        <div className="mb-10 sm:mb-12 lg:mb-16 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          ...
          <p className="text-sm text-gray-500 lg:flex-shrink-0">{filteredProducts.length} products available</p>
        </div>

        {/* ── Mobile Filter Button — matches Banner CTA pill style ── */}
        ...
        <div className="flex flex-col lg:flex-row gap-10">
            ...
            <div className="space-y-8">
              ...
              <div className="border-b border-gray-100 pb-8">
                ...
                <div className="space-y-1">
                  {categories.map(category => (
                    <label key={category} className="flex items-center gap-3 py-2 px-3 rounded-xl cursor-pointer hover:bg-gray-50 transition-colors group">
                      <input
                        type="checkbox"
              ...
              <div className="border-b border-gray-100 pb-8">
                ...
                <div className="space-y-1">
                  {[
                    ...
                    { label: 'Organic Only', key: 'organic' as const },
                  ].map(({ label, key }) => (
              ...
              <div className="border-b border-gray-100 pb-8">
                ...
                <select
                  ...
                  onChange={e => setFilters(prev => ({ ...prev, rating: e.target.value ? Number(e.target.value) : null }))}
              ...
              {/* Clear Filters — exact same pill style as Catalog "See Products" button */}
              <button
          ...
          <main className="flex-1 min-w-0">
            ...
            {/* Active filter tags — using landing pastel colors */}
            {activeFilterCount > 0 && (
              <div className="flex flex-wrap gap-2 mb-6">
                ...
                {filters.organic && (
                  <button onClick={() => setFilters(prev => ({ ...prev, organic: false }))}
                    className="flex items-center gap-1.5 px-3 py-1.5 bg-[#B3E5C9] rounded-full text-xs font-semibold text-gray-700 hover:opacity-80 transition-opacity">
                    Organic <X size={10} />
                  </button>
                )}
                {filters.inStock && (
                ...
                {filters.rating && (
                  <button onClick={() => setFilters(prev => ({ ...prev, rating: null }))}
                    className="flex items-center gap-1.5 px-3 py-1.5 bg-[#FFCAB3] rounded-full text-xs font-semibold text-gray-700 hover:opacity-80 transition-opacity">
            ...
            {filteredProducts.length === 0 ? (
              ...
              /* Grid — identical structure to ProductCatalog */
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 sm:gap-6">
                {filteredProducts.map(product => (
                  ...
                  >
                    ...
                    {/* Content — mirrors ProductCatalog card body exactly */}
        ...
        {/* ── Bottom CTA — exact "See Products" pill from Catalog ── */}
